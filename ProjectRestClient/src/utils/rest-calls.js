...
import {PROJECT_FLIGHTS_BASE_URL} from './consts';
...
export function GetFlights(){
    ...
    let request = new Request(PROJECT_FLIGHTS_BASE_URL, myInit);

    console.log('Inainte de fetch GET pentru '+PROJECT_FLIGHTS_BASE_URL)
...
export function DeleteFlight(id){
    ...
    const flightDelUrl=PROJECT_FLIGHTS_BASE_URL+'/'+id;
...
export function AddFlight(flight){
    ...
    return fetch(PROJECT_FLIGHTS_BASE_URL,antet)
        .then(status)
        .then(response=>{
            return response.text();
        }).catch(error=>{
...
export function UpdateFlight(flight){
    ...
    return fetch(PROJECT_FLIGHTS_BASE_URL +'/'+ flight.id ,antet)
        .then(status)
        .then(response=>{
            return response.text();
        }).catch(error=>{
